                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(
                          width: 8), // Add some spacing between elements
                      AppText(
                        text: AppStrings.What_happening,
                      ),
                      const Spacer(), // Push the dropdown to the right
                      Image.asset(
                        AppImages.language,
                        height: 20,
                      ),
                  ...
                  GridView.builder(
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      childAspectRatio: 3.0, // Adjust based on your chip dimensions
                    ),
                    shrinkWrap: true,
                    physics: NeverScrollableScrollPhysics(), // Prevents scrolling within the GridView
