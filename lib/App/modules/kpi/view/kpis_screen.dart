...
class KpisScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('KPIs & Stats', style: TextStyle(fontWeight: FontWeight.bold)),
          backgroundColor: Colors.white,
          elevation: 0,
        ),
        body: Obx(()=>controller.isLoading.value?KpisShimmer():SingleChildScrollView(
          child: Padding(
            padding: const EdgeInsets.all(16.0),
            child: Column(
              children: controller.metrics.map((metric) => _buildMetricSection(metric)).toList(),
            ),
          ),
        )),
      ),
  ...
  Widget _buildMetricSection(String metric) {
  ...
  Widget _buildGraph(String metric) {
              ...
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (value, meta) {
                  ...
                  if (index >= 0 &&
                    ...
                    final timestamp = controller.graphData[metric]![index]['timestamp'];
                    return Padding(
  ...
  Widget _buildStatsTable(String metric) {
    final data = controller.statsData[metric] ?? {};
    final List<String> labels = ['Daily', 'Weekly', 'Monthly', 'YTD', 'Annually', 'All Time'];
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ...labels.map((label) => _buildCell(label, width: Get.width * 0.2, isHeader: true)),
                ],
              ),
            ),
            // Data Row
  ...
  }  List<FlSpot> _getSampleData(String metric) {
