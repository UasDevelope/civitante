...
//               CustomPaint(painter: DottedOvalPainter()),
//               Positioned(
//                 bottom: 100,
//                 child: AppText(
//                   text: "${controller.countdown.value} seconds remaining",
...
//
//   DottedOvalPainter(
//       {this.widthRadius = 100, this.heightRadius = 140, this.dotSize = 4, this.gap = 10});
//
//   @override
